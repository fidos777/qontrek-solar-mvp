...
export default function Dashboard() {
  ...
  const deals: Deal[] = [
    { id: '1', customer: 'Ahmad Abdullah', location: 'Petaling Jaya', system: '5.5 kW', stage: 'Quote sent', value: 22500, tag: '🔥 Hot Lead', tagColor: 'orange' },
    { id: '2', customer: 'Siti Aminah', location: 'Shah Alam', system: '8 kW', stage: 'Site visit scheduled', value: 32000, tag: '✓ Qualified', tagColor: 'green' },
    { id: '3', customer: 'Syarikat ABC Sdn Bhd', location: 'Klang', system: '80 kW commercial', stage: 'Proposal review', value: 168000, tag: '⭐ Enterprise', tagColor: 'cyan' },
    { id: '4', customer: 'Lee Wei Ming', location: 'Subang', system: '4 kW', stage: 'No response', value: 16000, tag: '⚠️ Follow up', tagColor: 'red' },
  ];
      ...
      <div style={{ background: '#0f172a', minHeight: '100vh', color: 'white', padding: '1rem' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1rem', marginBottom: '1.5rem' }}>
            <StatCard label="Active AI Workers" value="5" sub="● All operational" subColor="#22c55e" />
            <StatCard label="Tasks Today" value="24" sub="18 completed • 6 pending" subColor="#94a3b8" />
            <StatCard label="Pipeline Value" value={`RM ${(pipelineValue/1000).toFixed(0)}k`} sub="11 active deals" subColor="#94a3b8" valueColor="#22c55e" />
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '1.5rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                  ...
                  {deals.map(d => (
                    <div key={d.id} style={{ 
                      ...
                      <div style={{ textAlign: 'right' }}>
                        ...
                        <div style={{ fontSize: '0.75rem', color: d.tagColor === 'orange' ? '#f97316' : d.tagColor === 'green' ? '#22c55e' : d.tagColor === 'cyan' ? '#06b6d4' : '#ef4444' }}>
                          {d.tag}
                        </div>
                      </div>
                    </div>
              ...
              <Card title="🔒 CIVOS Governance Log" badge={{ label: 'Type B Active', color: '#3b82f6' }}>
                <div style={{ fontFamily: 'monospace', fontSize: '0.875rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                  {logs.map((log, i) => (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              ...
              <div style={{ background: '#1e293b', borderRadius: '12px', border: '1px solid #334155', padding: '1rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                ...
                <button style={{ padding: '0.75rem', background: '#22c55e', borderRadius: '8px', fontWeight: '500', fontSize: '0.875rem', border: 'none', color: 'white', cursor: 'pointer' }}>
                  📱 Send WhatsApp Batch
                </button>
                <button style={{ padding: '0.75rem', background: '#334155', borderRadius: '8px', fontWeight: '500', fontSize: '0.875rem', border: 'none', color: 'white', cursor: 'pointer' }}>
